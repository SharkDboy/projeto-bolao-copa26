...
| [`seed-matches-2026.sql`](seed-matches-2026.sql) | 104 partidas Copa 2026 |
| [`functions/sync-match-results/`](functions/sync-match-results/) | Cron de sync openfootball |

## Setup rápido

1. `RODE-ANTES-DE-USAR.sql`
2. `seed-matches-2026.sql`
3. `npm run sync:matches` (atualiza placares quando o JSON tiver `score.ft`)
